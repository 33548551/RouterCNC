...
/*************************************************************************************
/*Este es el l�mite Pin Cambio de interrupci�n, que se encarga de la funci�n de l�mite duro. Un rebote
final de carrera puede causar muchos problemas, como falsas lecturas y m�ltiples llamadas de interrupci�n.
� Si un interruptor se activa en absoluto, algo malo le ha sucedido y lo tratan como tal, independientemente
si se est� desacoplado un final de carrera. Es imposible saber con fiabilidad el estado de un
� rebotando pin sin un m�todo eliminaci�n de rebotes. Un software simple supresi�n de rebotes caracter�stica puede ser habilitada
� a trav�s del archivo config.h, donde un contador de tiempo adicional retrasa el pasador l�mite le�do por varios mili-
segundos para ayudar con, no fija, rebotando interruptores.
// NOTA: No conecte una direcci�n de detener a los pines l�mite, ya que esta interrupci�n se desactiva durante la
homing ciclos y no responder� correctamente. A petici�n de usuario o necesidad, puede haber una
� pinout especial para un e-stop, pero por lo general se recomienda conectar simplemente directamente
� su interruptor de parada de emergencia a la Arduino restablecer pin, ya que es la forma m�s correcta de hacer esto.
*/
/*
