...
//----------------------------------------------------------------------------------------
  ...
  #define Y_DIRECTION_BIT   7  // Uno Digital Pin 6 (modificado Torres)                                                             
...
//----------------------------------------------------------------------------------------
  ...
  #define Y_STEP_BIT        4 // MEGA2560 Digital Pin 25  ( Modificado  Torres
  ...
  #define Y_DIRECTION_BIT   7 // MEGA2560 Digital Pin 28 (  Modificado Torres
  #define Z_DIRECTION_BIT   6 // MEGA2560 Digital Pin 29  """""""""""""""""""
  #define DIRECTION_MASK ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT)) // All direction bits
